...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.scaling_lr = 0.005 # 学习率不一样  原0.001
        ...
        self.densify_until_iter = 30_000 #36_000 #15_000 不一样
        self.densify_grad_threshold = 0.0002 #不一样
        self.prune_opacity_threshold = 0.005 #多的 源代码是直接在代码里面输入0.005
        ...
        self.lpips = 0.0
        self.dxyz = 0.0
        self.start_deform_env = 0
        self.scale_loss = 0.0
        self.start_sugarloss = 10000
        self.start_aiaploss = 60000
