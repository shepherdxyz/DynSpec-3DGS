...
from scene.deform_model import DeformModel, Env_DeformModel,Cube_DeformModel,Cube_DeformModel_Normal
...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0]):
        ...
        self.cameras_center = -scene_info.nerf_normalization['translate'] # 这里比deformgs多的
