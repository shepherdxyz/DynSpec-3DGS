...
def readNerfiesCameras(path):
    ...
    for idx in range(len(all_img)):
        ...
        cx = all_cam_params[idx]['principal_point'][0]
        cy = all_cam_params[idx]['principal_point'][1]
        K = np.array([
                [focal, 0, cx],
                [0, focal, cy],
                [0, 0, 1],
...
#         focal_x = all_cam_params[idx]['focal_length']
#         focal_y = focal_x * all_cam_params[idx]['pixel_aspect_ratio']
# #pixel_aspect_ratio
#         cx = all_cam_params[idx]['principal_point'][0]
#         cy = all_cam_params[idx]['principal_point'][1]
#         K = np.array([
